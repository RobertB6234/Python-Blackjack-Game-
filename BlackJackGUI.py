'''
File: Blackjack GUI.oy
Date: 9/8/17
Author: RB
Project: 9-4

GUI version of Blackjack card game
'''
from tkinter import  *
...
class BlackjackGUI(Frame):
	...
	# Create the event handle methods
	def _newGame(self):
		'''Instantiates the modle and establishes the GUI'''
	...
	def _hit(self):
		...
		if points >= 21:
			self._pass() #Hits the dealer to finnish
